...
namespace JsonRpc.Standard.Server
{
    ...
    public sealed class JsonRpcServiceHostBuilder
    {
        ...
        /// <remarks>
        /// <para>If there are multiple calls to this method, the handler generated by the last applied middleware
        ...
        /// </remarks>
        // NextHandler --> InterceptedHandler
        ...
        public IJsonRpcServiceHost Build()
        {
            ...
            host.BuildPipeline(interceptions.Reverse());
            return host;
        }
    }

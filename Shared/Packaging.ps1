...
$VersionNode = Select-Xml .\Shared\JsonRpc.Packages.props -XPath //Version
if (-not $VersionNode) {
...
msbuild JsonRpc.Standard.sln -p:Configuration=Release -p:Platform="Any CPU" -v:m
msbuild JsonRpc.Standard.sln -p:Configuration=Documentation -p:Platform="Any CPU" -v:m
